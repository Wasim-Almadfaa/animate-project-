...
button.addEventListener("click", () => {
    ...
    div.setAttribute('id',"content"+ (divs.length + 1));
    div.style.backgroundColor = '#aabbbb';
    div.style.textAlign = 'center';
    div.style.width = '300px';
    div.style.height = '200px';
    div.style.color = '#fff';
    div.textContent = "Drag and resize me!";
...
class boxCreater{
    constructor(button, name, Option) {
        this.name = name;
        this.Option = Option()
        this.button = button.addEventListener('click', this.creator.bind(this));
        
    }
    Option(date) {
        this.date.first = first;
        this.date.second = second;
        this.date.third = third;
    }
}
    ...
    // < div id= "content1" style= "background-color:#aabbbb;
    // text - align:center;
    // width: 300px;
    // height: 200px;
    // color: #fff">Drag and resize me!</div>